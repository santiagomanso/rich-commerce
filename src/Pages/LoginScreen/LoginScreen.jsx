...
const LoginScreen = () => {
  ...
  }, [user, navigate, error]); // REVIEW why are you including the navigate function in the dependecy array, is it really necessary?In every render that function will have a different reference, so the risk of falling into an infinite loop is big.
