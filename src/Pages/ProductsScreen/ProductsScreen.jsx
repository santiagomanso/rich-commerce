...
const ProductsScreen = () => {
  ...
  const filterItems = items.filter((item, i) => {
    return item.category_id == categoryId; // REVIEW Try to always use strict comparisson, unless there is a very good reason not to, and in that case leave it explained.
  });
