export const products = [
  {
    ...
    name: 'Necker Island',
    img: 'https://www.vladi-private-islands.de/fileadmin/islands/caribbean/rent/necker_island/necker-island-bvi-30.jpg',
    left_col: 'Location: British Virgin Islands',
    stock: 1,
    price: 100000000,
    desc: 'Although this island is owned by Richard Branson, its value is at $100 million and offers the ideal location for your next family gathering. If you want to throw the most lavish party, this is the island you should be looking at.',
    test: 0,
  },
  {
    product_id: 1,
    ...
    left_col: 'Location: Hawaii',
    stock: 1,
    price: 500000000,
    desc: 'Valued at $500 million, the Lanai Island is hands down the best and most expensive island in Hawaii and the world at large. Its owner, Larry Ellison, is also the founder of Oracle. As the worlds eighth richest person, it comes as no surprise that he has his name written on this plush and extravagant island. ',
    test: 0,
  },
  {
    product_id: 4,
    category_id: 6, //private islands
    name: 'Bg Darby Island',
    img: 'https://www.vladi-private-islands.de/fileadmin/islands/caribbean/sell/big_darby_island/big_darby_island_009.jpg',
    left_col: 'Location: Bahamas',
    stock: 1,
    price: 39000000,
    desc: 'The Bahamas are the perfect spot for a summer break to soak in the sun. Owning a private island in this tropical paradise would be the icing on the cake. The Big Darby Island will set you back by $40 million but it will also offer you the extravagant life that you so crave.',
    test: 0,
  },
  {
    product_id: 3,
